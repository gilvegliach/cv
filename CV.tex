...
%     \item {\it Project}: Zalando shop app
%      \item {\it Boss}: Christoph Springer 
\end{itemize}
...
%      \item {\it Supervisor}: Andreas Bauer (andreas.bauer@nicta.com.au)
%      \item {\it Topics}: runtime monitoring of mobile malware, Android development, behavioural detection
\end{itemize}
\end{itemize}
