...
\bigskip
\textsc{Keywords}: 
AWS, EC2, DynamoDB, JSON, REST, Microservices, Scala, Play 2.x, SBT, C++, Java, Android,
Spring, Maven, Gradle, Dagger~2, Guice, Butterknife, Retrofit, Gson, Espresso, JUnit, 
...
\begin{no-indent-itemize}
  ...
  \begin{itemize}
    \item\bullet Works on improving search algorithms (Geocoding and Geo Search Quality).
    \item\bullet Mentored new engineers.
    \item\bullet Interviewed engineer candidates.
  \end{itemize}
...
\begin{no-indent-itemize}
  ...
  \item Accounting \& Financial Statement Analysis by 365 Careers
        (\href{https://goo.gl/sUgBXG}{https://goo.gl/sUgBXG})
\end{no-indent-itemize}
